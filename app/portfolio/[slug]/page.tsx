      ...
      <main className="container mx-auto flex flex-col gap-16 px-4 py-16 md:gap-20 md:py-20 lg:py-24">
        ...
        <section className="grid gap-8 md:grid-cols-3">
          {project.stats.map((stat) => (
            <div
              key={stat.label}
              className="rounded-3xl border border-border/70 bg-background/80 p-6 text-center shadow-sm"
            >
        ...
        <section className="grid gap-6 md:grid-cols-2">
          {project.highlights.map((highlight) => (
            <div
              key={highlight.title}
              className="rounded-3xl border border-border/60 bg-background/80 p-6 shadow-sm transition hover:border-primary/40 hover:shadow-lg"
            >
