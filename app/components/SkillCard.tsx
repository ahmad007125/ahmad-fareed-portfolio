...
export default function SkillCard({ title, description, image, focusAreas, className }: SkillCardProps) {
  return (
    <div
      className={cn(
        "flex h-full flex-col gap-4 rounded-2xl border border-border/60 bg-background/90 shadow-sm transition hover:border-primary/40 hover:shadow-lg overflow-hidden",
        className
      )}
    >
      <div className="p-6">
